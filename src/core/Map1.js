  ...
  useEffect(() => {
    if (start && end && userPosition) {
      ...
      if (algorithm === 'dijkstra') {
        apiUrl = `http://192.168.49.2:32560/dijkstra?start=${start}&end=${end}`;
      } else if (algorithm === 'bellmanford') {
        apiUrl = `http://192.168.49.2:31353/bellmanford?start=${start}&end=${end}`;
      } else if (algorithm === 'astar') {
        apiUrl = `http://192.168.49.2:31657/astar?start=${start}&end=${end}`;
      }
